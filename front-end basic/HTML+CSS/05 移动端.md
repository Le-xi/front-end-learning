...
![300](images/Pasted_image_20241010211509.png)

2. 视觉视口 visual viewport
字面意思，它是用户正在看到的网站的区域。注意：是网站的区域。我们可以通过缩放去操作视觉视口，但不会影响布局视口，布局视口仍保持原来的宽度。  
![300](images/Pasted_image_20241010211621.png)
...
![](images/Pasted_image_20241010220933.png)
...
![400](images/Pasted_image_20241012142953.png)
...
```
常见 flex 布局思路。
![](images/Pasted_image_20241015142047.png)
...
![](images/Pasted_image_20241018154924.png)

该插件的默认 `root font size` 为 16px，在设置中将其改为设计稿的宽度除以份数即可，如设计稿为 750px，分为 10 份，则改为 75.
![](images/Pasted_image_20241018155040.png)
