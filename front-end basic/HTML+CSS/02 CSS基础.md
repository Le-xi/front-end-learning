...
![](images/Pasted_image_20240129115545.png)
## 8.3 行内块元素
...
![](images/Pasted_image_20240605151614.png)
## 11.1 边框 border
...
![相邻块元素垂直外边距的合并](images/Pasted_image_20230404104840.png)
解决方案：只给一个盒子添加 margin 值。
（2）对于两个嵌套关系（父子关系）的块元素，父元素有上外边距同时子元素也有上外边距，此时父元素会只会取两个值中较大的外边距值。
![](images/Pasted_image_20230404143858.png)
解决方案：
- 可以为父元素定义上边框。  
- 可以为父元素定义上内边距。  
...
![](images/Pasted_image_20230421221513.png)
![](images/Pasted_image_20230421221542.png)
第三种布局的示例代码：
```html
<!DOCTYPE html>
<html lang="en">
...
当子盒子设置了浮动，父盒子不给高度：
![](images/Pasted_image_20240608153152.png)
...
![](images/Pasted_image_20240617140247.png)
1. 静态定位
...
- IE6 等低版本浏览器不支持固定定位。
![](images/Pasted_image_20240618141316.png)
（3）经典应用：固定到版心右侧。
...
![](images/Pasted_image_20240618144541.png)
...
```
![](images/Pasted_image_20240619150048.png)
...
```
![](images/Pasted_image_20240619150234.png)
...
![](images/Pasted_image_20240619150347.png)
