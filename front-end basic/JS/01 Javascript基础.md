...
![](images/Pasted_image_20240625082732.png)
![](images/Pasted_image_20240625082833.png)
(1) 数值
...
![](images/Pasted_image_20240625082813.png)
## 5.3 类型转换
A. 隐式转换
...
（3）运算符优先级
![](images/Pasted_image_20240618081531.png)
...
join(separator)
```
![](images/Pasted_image_20241031143228.png)
# 9 函数
（1）声明和调用
